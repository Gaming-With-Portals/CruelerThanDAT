...
FileNode* CPKManager::GetFileNodeFromCPK(CRIFILE file, CRIFOLDER folder) {
...
void CPKManager::DrawSubitems(const CRIFOLDER& folder, const std::string& searchQuery) {
...
void CPKManager::DrawFolder(const CRIFOLDER& folder, const std::string& searchQuery, bool isFirst) {
	if (isFirst) {
